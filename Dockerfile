...
ARG APP_PATH=/icalia-actions/aws-configure-elb-rule
...
ARG APP_PATH=/icalia-actions/aws-configure-elb-rule
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/aws-configure-elb-rule
WORKDIR /icalia-actions/aws-configure-elb-rule
